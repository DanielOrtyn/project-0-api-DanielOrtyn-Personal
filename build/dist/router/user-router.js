...
var aut_middleware_1 = require("../middleware/aut.middleware");
 ...
 * endpoint: /users/:id
 */
exports.userRouter.get("/:id", [aut_middleware_1.authMiddleware(['admin']),
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, user_service_1.GetUser(id)];
                case 1:
                    user = _a.sent();
                    console.log(user);
                    res.send(user);
 ...
 */
exports.userRouter.get("/username/:username", function (req, res) {
