...
var User_dto_1 = require("./model/DataTransferObject/User.dto");
var user_service_1 = require("./router/service/user-service");
...
app.post("/login", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var _a, username, password, serverRes;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                console.log("login request made");
                _a = req.body, username = _a.username, password = _a.password;
                return [4 /*yield*/, user_service_1.ValidateLogin(username, password)];
            case 1:
                serverRes = _b.sent();
                if (serverRes) {
                    req.session.user = User_dto_1.convertSqlUser(serverRes[0]);
